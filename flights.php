...
<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="<?php bloginfo('template_directory');?>/images/cover_bg_3.jpg">
				<div class="desc">
					<div class="container">
						<div class="row">
		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			<div class="container">
				...
				<div class="row row-bottom-padded-md">
					...
					<div class="col-md-6 animate-box">
						<img class="img-responsive" src="<?php bloginfo('template_directory');?>/images/cover_bg_3.jpg" alt="travel">
				...
				<div class="row row-bottom-padded-md">
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="<?php bloginfo('template_directory');?>/images/place-4.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>New York</h3>
								<span>3 nights</span>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="<?php bloginfo('template_directory');?>/images/place-5.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Philippines</h3>
								<span>4 nights</span>
					...
					<div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
						<div href="#"><img src="<?php bloginfo('template_directory');?>/images/place-6.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
							<div class="desc">
								<span></span>
								<h3>Hongkong</h3>
								<span>2 nights</span>
