...
<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="<?php bloginfo('template_directory');?>/images/cover_bg_4.jpg">
				<div class="desc">
					<div class="container">
						<div class="row">
				...
				<div class="row row-bottom-padded-md">
					<div class="col-md-6 animate-box">
						<div class="car">
							...
							<div class="one-1" style="<?php bloginfo('template_directory');?>/images/car-1.jpg">
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="car">
							...
							<div class="one-1" style="<?php bloginfo('template_directory');?>/images/car-2.jpg">
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="car">
							...
							<div class="one-1" style="<?php bloginfo('template_directory');?>/images/car-3.jpg">
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="car">
							...
							<div class="one-1" style="<?php bloginfo('template_directory');?>/images/car-4.jpg">
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="car">
							...
							<div class="one-1" style="<?php bloginfo('template_directory');?>/images/car-5.jpg">
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="car">
							...
							<div class="one-1" style="<?php bloginfo('template_directory');?>/images/car-6.jpg">
							</div>
						</div>
					</div>
				</div>
