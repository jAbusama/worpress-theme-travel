...
<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="<?php bloginfo('template_directory');?>/images/cover_bg_5.jpg">
				<div class="desc">
					<div class="container">
						<div class="row">
		...
		<div id="fh5co-tours" class="fh5co-section-gray">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 animate-box">
						<img class="img-responsive" src="<?php bloginfo('template_directory');?>/images/cover_bg_2.jpg" alt="travel">
					</div>
				</div>
			</div>
		</div>
